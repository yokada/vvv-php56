...
* Databases can now be dropped in phpMyAdmin. Pro-tip, `drop database wordpress_develop` in phpMyAdmin followed by `vagrant provision` clears your src2.wordpress-develop.dev for reinstall.
...
* **Possible Breaking:** Change VM hostname to `vvv2.dev`
